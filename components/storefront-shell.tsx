    ...
    <div className="min-h-screen bg-white text-slate-900">
      <header className="sticky top-0 z-20 border-b border-slate-100 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
          <Link href="/" className="text-xl font-bold tracking-tight">
            Web<span className="text-teal-600">Klaar</span>
          </Link>
          ...
          <Link
            href="/bestellen/"
            className="rounded-full bg-teal-600 px-4 py-2 text-sm font-semibold text-white sm:hidden"
          >
            Bestel
          </Link>
        </div>
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1 text-sm text-slate-500">
                <li>
                  <Link href="/diensten/vakman-site/" className="hover:text-teal-600">
                    Vakman Website €899
                  </Link>
                </li>
                <li>
                  <Link href="/diensten/google-start/" className="hover:text-teal-600">
                    Google Start €299
                  </Link>
                </li>
                <li>
                  <Link href="/diensten/" className="hover:text-teal-600">
                    Alle diensten →
                  </Link>
                </li>
              </ul>
      ...
      {cta && (
        <div className="fixed bottom-0 left-0 right-0 border-t border-slate-200 bg-white p-3 sm:hidden">
          <Link
            href="/bestellen/"
            className="block rounded-full bg-teal-600 py-3 text-center text-sm font-bold text-white"
          >
            Bestel een dienst →
          </Link>
        </div>
